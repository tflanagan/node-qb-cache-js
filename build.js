...
const SRC_FILE = join('.', 'QBCache.js');
const ES5_FILE = join('.', 'QBCache.es5.js');
const BROWSERIFY_FILE = join('.', 'QBCache.browserify.js');
const MINIFIED_FILE = join('.', 'QBCache.browserify.min.js');
